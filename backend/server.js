...
EXCEPCIÓN — "hallazgo", "causas" y "riesgos" SÍ pueden explicarse con conocimiento automotriz general: para estos campos de cada diagnóstico, usa tu conocimiento automotriz general para explicar con un poco más de detalle qué implica la falla o el ítem descrito y por qué importa, tal como lo haría un mecánico experimentado explicándole al cliente, aunque ese detalle exacto no esté en la cotización (ejemplo: para "amortiguadores rotos" el hallazgo puede explicar brevemente qué función cumplen y qué significa que estén rotos, no solo repetir la descripción cotizada; la causa puede ser "desgaste por uso y kilometraje" y el riesgo "ruidos e inestabilidad al conducir", sin que esa causa/riesgo exacta haya sido dada). Sigue siendo coherente con el ítem descrito — no inventes hallazgos, causas o riesgos de un sistema distinto al mencionado, ni datos específicos de este vehículo en particular (mediciones, marcas, fechas) que no te hayan dado. "hallazgo" debe tener 2 a 4 frases (no una sola línea seca). Escribe 1 a 3 causas y 1 a 3 riesgos por diagnóstico; solo déjalos vacíos si el ítem realmente no tiene ninguna causa o riesgo aplicable (ej. mantenimiento de rutina sin falla).
  ...
  "diagnosticos": [
    {
      ...
      "hallazgo": "2 a 4 frases claras y sencillas explicando lo que se encontró o el trabajo a realizar y qué implica para el vehículo, partiendo de la descripción del ítem cotizado o las observaciones dadas y ampliando con conocimiento automotriz general (ver EXCEPCIÓN arriba) — sin inventar datos específicos de este vehículo, sin precios.",
