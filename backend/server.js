...
EXCEPCIÓN — "hallazgo", "causas" y "riesgos" SÍ pueden explicarse con conocimiento automotriz general: para estos campos de cada diagnóstico, usa tu conocimiento automotriz general para explicar con detalle qué implica la falla o el ítem descrito, cómo funciona el componente y por qué importa, tal como lo haría un mecánico experimentado explicándole al cliente, aunque ese detalle exacto no esté en la cotización (ejemplo: para "amortiguadores rotos" el hallazgo puede explicar qué función cumple el amortiguador, qué significa que esté roto y cómo afecta la conducción, no solo repetir la descripción cotizada; la causa puede ser "desgaste por uso y kilometraje" y el riesgo "ruidos e inestabilidad al conducir", sin que esa causa/riesgo exacta haya sido dada). Sigue siendo coherente con el ítem descrito — no inventes hallazgos, causas o riesgos de un sistema distinto al mencionado, ni datos específicos de este vehículo en particular (mediciones exactas, marcas de repuesto, fechas, kilometrajes de cambio anteriores) que no te hayan dado — puedes explicar EN GENERAL cómo funciona y por qué falla ese tipo de componente, pero sin afirmar cifras o hechos puntuales de este vehículo que no se te dieron. "hallazgo" debe tener 4 a 6 frases con una explicación completa (no una sola línea seca ni un resumen apretado). Escribe 2 a 4 causas y 2 a 4 riesgos por diagnóstico, cada una en una frase completa y no solo una palabra suelta; solo déjalos vacíos si el ítem realmente no tiene ninguna causa o riesgo aplicable (ej. mantenimiento de rutina sin falla).

REGLAS DE CONTENIDO:
- Puedes usar lenguaje técnico automotriz normal (nombres de sistemas, piezas, términos mecánicos habituales) — no es necesario simplificar en exceso ni evitar vocabulario técnico común. Lo que se evita es inventar datos puntuales y precisos que no te dieron (medidas exactas, números de pieza, marcas, fechas), no el vocabulario técnico en sí.
  ...
  "diagnosticos": [
    {
      ...
      "hallazgo": "4 a 6 frases explicando con detalle lo que se encontró o el trabajo a realizar, cómo funciona el sistema/componente y qué implica para el vehículo. Puede usar vocabulario técnico automotriz normal. Parte de la descripción del ítem cotizado o las observaciones dadas y amplía con conocimiento automotriz general (ver EXCEPCIÓN arriba) — sin inventar datos puntuales específicos de este vehículo (medidas, marcas, fechas), sin precios.",
      "causas": ["2 a 4 causas probables típicas de este tipo de falla, cada una en frase completa, según conocimiento automotriz general (ver EXCEPCIÓN arriba); vacío solo si de verdad no aplica ninguna causa"],
      "riesgos": ["2 a 4 riesgos típicos de no atender esta falla, cada uno en frase completa, según conocimiento automotriz general (ver EXCEPCIÓN arriba); vacío solo si de verdad no aplica ningún riesgo"],
